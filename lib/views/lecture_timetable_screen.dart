...
import 'package:demo_tdgacademy/extensions/extensions.dart';
...
class LectureTimeTableScreen extends StatefulWidget {
  const LectureTimeTableScreen({Key? key}) : super(key: key);
        ...
        body: Container(
          ...
          child: SfCalendar(
            ...
            monthViewSettings: const MonthViewSettings(
                showAgenda: false, numberOfWeeksInView: 3),
                  ...
                  children: [
                    Image(
                        image: ExactAssetImage(
                            'assets/month_background/month_${details.date.month}.png'),
                        fit: BoxFit.cover,
