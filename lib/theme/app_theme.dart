...
import 'package:demo_tdgacademy/theme/theme_type.dart';
...
class AppTheme {
  ...
  static ThemeData learningLightTheme = createTheme(
    ColorScheme.fromSeed(
        seedColor: const Color(0xfe162039),
        secondary: const Color(0xfffe4c1c),
        onSecondary: const Color(0xffffffff),
        secondaryContainer: const Color(0x1dfe4c1c),
        onSecondaryContainer: const Color(0xef162039)),
  );
  static ThemeData learningDarkTheme = createTheme(
    ColorScheme.fromSeed(
        seedColor: const Color(0x2c162039),
        primary: const Color(0xffcfd2ff),
        onPrimary: const Color(0xff162039),
        primaryContainer: const Color(0xff162039),
        onPrimaryContainer: const Color(0xffe6e7fd),
        secondary: const Color(0x1dfe4c1c),
        onSecondary: const Color(0xff253e14),
        secondaryContainer: const Color(0xfffe4c1c),
        onSecondaryContainer: const Color(0x2c162039),
        onBackground: const Color(0xffe6e1e5)),
  );
  ...
  static resetFont() {
    ...
    FxTextStyle.changeDefaultTextFontWeight({
